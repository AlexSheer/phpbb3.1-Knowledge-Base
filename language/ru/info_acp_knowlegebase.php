...
// Moderator Permissions
	...
	'LOG_LIBRARY_APPROVED_ARTICLE'		=> 'Одобрена статья %1s из категории » %2s<br />добавленая пользователем » %3s',
	'LOG_LIBRARY_REJECTED_ARTICLE'		=> 'Отклонена статья %1s из категории » %2s<br />добавленая пользователем » %3s',
