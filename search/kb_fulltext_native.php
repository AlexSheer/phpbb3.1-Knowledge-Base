...
class kb_fulltext_native extends \Sheer\knowlegebase\search\kb_base
{
	...
	*/
	...
	{
		return 'phpBB Knowlege Base Native Fulltext';
	}
...
/*
			if ($author_name)
			{
				...
				$sql_author = '(' . $this->db->sql_in_set('p.author_id', array_diff($author_ary, array(ANONYMOUS)), false, true) . ' OR p.post_username ' . $author_name . ')';
			}
			else
*/
			{
